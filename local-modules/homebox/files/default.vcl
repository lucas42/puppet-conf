...
sub vcl_recv {
        ...
        if (req.http.host == "progs.l42.eu") {
                ...
                set req.backend = progs;
        } elsif (req.http.host == "private-old.l42.eu") {
                set req.backend = arkb;
                ...
                set req.backend = apache;
        } elsif (req.http.host == "vlc.l42.eu") {
                set req.backend = vlc;
                return (pass); #turn off caching
        } elsif (req.http.host == "aurora.lukeblaney.co.uk" || req.http.host == "nas.l42.eu") {
                set req.backend = aurora;
        } elsif (req.http.host == "thunderbird5.s.l42.eu" || req.http.host == "dlinkrouter.l42.eu") {
                set req.backend = thunderbird5;
        } elsif (req.http.host == "btrouter.l42.eu") {
                set req.backend = btrouter;
        } else {
